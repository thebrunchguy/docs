...
<Accordion title="What's the difference between Send Invitations and Send Introductions when scheduling an Intro Round?">
  When scheduling an Intro Round, you’ll notice two different dates and times that you must select. 
...
The second, “Choose Time to Send Introductions”, refers to the email sent to members who are in the Intro Round (either they opted-in if you chose opt-in when customizing, or didn’t opt-out if you chose opt-out when customizing) introducting them to their match.
</Accordion>
