...
<Accordion title="Why did I get an Attention Needed warning when inviting new members?">
  You likely received the Attention Needed warning because of the email had a hard time going through. Emails can bounce due to incorrect email addresses, periodic network failures, or false positives from email security systems. 
