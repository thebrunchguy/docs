...
![](/Screenshot2025-06-12at2.50.30PM1.png)
...
<Steps>
  ...
  <Step title="Members Type in a Query">
    Below is an example of a member query: _"I'm looking for founders based in NYC."_ Ziv, our chatbot, will return relevant members based on the query.
...
Check out our demo on AI Search below\!

<iframe width="800" height="450" src="https://www.youtube.com/embed/i7uqbeatXfM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />