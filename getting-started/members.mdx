...
Free response: This provides an open space for members to freely write their answers
Single Select: This offers a single choice question format
Multi Select: This allows for a multiple choice question format
Custom Scale: A Likert scale with custom values. A great example is, "How many years of experience do you have?". Custom scale questions must have 5 values.
Two Part Multi: This give & take style question consists of two related questions that share a similar answer bank. For example, "Where could you use support?" and "How can you support others?"
  </Step>
</Steps>
