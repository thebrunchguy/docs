...
<Steps>
 ...
 You can customize your onboarding form to best fit your community! There are five different types of questions that you can create:

   <Accordion title="Free Response">
      This provides an open space for members to freely write their answers.
    </Accordion>
    <Accordion title="Single Select">
      This offers a single choice question format.
    </Accordion>
    <Accordion title="Multi Select">
      This allows for a multiple choice question format.
    </Accordion>
    <Accordion title="Custom Scale">
      A Likert scale with custom values. A great example is, "How many years of experience do you have?". Custom scale questions must have        5 values.
    </Accordion>
    <Accordion title="Two Part Multi">
      This give & take style question consists of two related questions that share a similar answer bank. For example, "Where could you use       support?" and "How can you support others?"
    </Accordion>
  </Step>
</Steps>
