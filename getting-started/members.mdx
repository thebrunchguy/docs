...
<Tabs>
  <Tab title="Tags">
    For example, you could use the tag "Founder" and "New York" to search for founders in your community who live in New York.
    
    ![](/images/Members-Filters-Tags.png)
  </Tab>
  <Tab title="Questions">
    For instance, you could ask "How long have you been part of the community?" and tailor the answer to a specific time frame to find individuals who are deeply involved in the community.
