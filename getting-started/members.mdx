...
<Steps>
  ...
  To create tags, navigate to the Tag Manager at the top right of the page. Within the Tag Manager, you can add Tags by clicking '+ Add Tag' in the bottom left corner. For example, if you wanted to view all of the founders in your community as a group by location, you could create Tags for "Founder", as well as all major cities in the US, as shown below.
