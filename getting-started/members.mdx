...
<Steps>
 ...
 <Accordion title="Upload the CSV File">
   ...
   <Accordion title="Manage Uploaded Members">
    > **Activate Without Invitation:** You can upload members without sending an invitation. These members will be added to the Pending tab, where you can manually activate them by selecting individuals or all and then clicking "Activate Selected".
