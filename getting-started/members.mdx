...
![](/Screenshot2025-05-22at1.02.01PM1.png)
...
<Steps>
  <Step title="Creating a Tag">
    ...
    ![Screenshot2025 05 22at1 04 13PM1 Pn](/images/Screenshot2025-05-22at1.04.13PM1.png)
  ...
  <Step title="Using Tags">
    ...
    ![](/Screenshot2025-05-22at1.06.36PM1.png)
  </Step>
</Steps>
...
<Tabs>
  <Tab title="Tags">
    ...
    ![](/Screenshot2025-05-22at1.09.53PM1.png)
  </Tab>
  <Tab title="Questions">
    For instance, you could use the custom question "What industry do you work in?" and tailor the answer to find individuals who work in your industry of choice.

    ![](/Screenshot2025-05-22at1.12.32PM1.png)
  </Tab>
</Tabs>
...
<iframe src="https://capture.navattic.com/cm0zvnjd7000k03mab6pv2c61?hideMobileAlert=true&scale=1" style={{ border:"none",width:"100%",height:"546px" }} allow="fullscreen" id="navattic-embed" />
...
![Screenshot2025 05 22at1 29 45PM1 Pn](/images/Screenshot2025-05-22at1.29.45PM1.png)

<Steps>
  <Step title="Uploading Member Data">
    Before inviting or activating your members, it's important to upload any existing member data (such as emails and names) via CSV if you have it. This ensures that the platform has all necessary information on your members.

    <Accordion title="Access the Add Members Button">
  ...
  <Step title="Inviting Members via Email">
    If you don't have pre-existing data, you can alternatively invite members via email.
    ...
    <Accordion title="Invite with Email">
      ...
      You can also select "All" in the Pending tab and click "Invite Selected".
    </Accordion>
    <Accordion title="Customize your Invitation Method">
      You have the option the customize the invitation to join by editing the template before sending it out to your members.
    </Accordion>
  </Step>
  <Step title="Adding Members through an Onboarding Link">
    If you prefer a simple and direct approach, and you don't have any member data, you can instead add members by sharing an onboarding link. This method allows members to join the community by accessing the form directly, without needing to accept an email invitation.
    ...
    <Accordion title="Copy the Onboarding Form Link">
      Navigate to the "Add Members" button.
  ...
  <Step title="Adding Members through Zapier">
    ...
    <Accordion title="Activate Your Zap">
      ...
      <Tip>
        **Pro Tip:** Zapier doesn't natively support two-way syncs — however, there's a workaround: apply filters to prevent data from constantly bouncing back and forth between Intros AI and your CRM. Reach out to us if you'd like help\!
      </Tip>
    </Accordion>
  </Step>
</Steps>
...
Additionally, you can toggle through different filters or use the search function to find specific members of your community. As shown below, you can sort members by **Active**, **Invited**, **Pending**, and **Deleted**.

---

<Tabs>
  <Tab title="Active">
    In the "Active" tab, you will see all members who have been activated or accepted an invitation to join your community.

    ![Screenshot2025 06 23at9 43 53AM Pn](/images/Screenshot2025-06-23at9.43.53AM.png)
  </Tab>
  <Tab title="Invited">
    In the "Invited" tab, you will see all of the members that have been invited to join your community.
    ...
    ![Screenshot2025 06 23at9 43 57AM Pn](/images/Screenshot2025-06-23at9.43.57AM.png)
  </Tab>
  <Tab title="Pending">
    In the "Pending" tab, you will see all of your members who have been uploaded via CSV, joined via an onboarding form or added via Zapier (you can choose to auto-activate folks who are added via the onboarding form and/or Zapier in your Club Settings).

    Members may be in the "Pending" tab for two reasons:

    - The member joined via the onboarding form or Zapier and "I will manually approve them" was toggled on in the Club Settings page.
    - You uploaded the members via CSV yourself.
    - Things you can do in the "Pending" tab:
      - Activate a member (as previously discussed in the "Invited" tab section).
      - Delete a member (then they will be marked as deleted).

    ![Screenshot2025 06 23at9 44 00AM Pn](/images/Screenshot2025-06-23at9.44.00AM.png)
  </Tab>
  <Tab title="Deleted">
    In the "Deleted" tab, you will see all of your members who have been deleted.

    ![Screenshot2025 06 23at9 44 04AM Pn](/images/Screenshot2025-06-23at9.44.04AM.png)
  </Tab>
</Tabs>
