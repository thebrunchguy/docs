...
<Tabs>
 ...
 You can also add custom tag rules, for example: "New York members must be matched with other New York members" and "VIP members must be matched with other VIP members."
