...
<Tabs>
  ...
  In the **Matching Rules** section, you can set up the rules you use and implement when scheduling an Intro Round.
    ...
    <Tip>
    **Pro Tip:** Visit the Intro Rounds section [Intro Rounds](https://docs.intros.ai/getting-started/intro-rounds.mdx) for a deeper dive into Matching and Tag Rules.
</Tip>
