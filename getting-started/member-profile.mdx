...
<Tabs>
  <Tab title="Basics">
    ...
    <Note>
    **Note:** Be sure to toggle on any member data if you already have it, so it maps correctly to the appropriate fields when you upload or invite members to join.
    </Note>
