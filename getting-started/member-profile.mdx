...
<Tabs>
  <Tab title="Basics">
    ...
    <Note>
    **Note:** Be sure to toggle on any data you already have for members to ensure it maps correctly to the appropriate fields when you upload or invite them to join.
    </Note>
